    ...
    <div className="min-h-screen w-full font-sans text-white bg-black py-10">
      ...
      <section id="intro" className="flex flex-col lg:flex-row  items-center text-left space-x-8 px-6 py-10">
        ...
        <div>
          ...
          <p className="text-lg text-gray-400">I usually <s>break</s> build things.</p>
        </div>
      </section>

      {/* About Section */}
      <section id="about" className="px-6 mb-5">
        <h2 className="text-2xl mb-1">About</h2>
        <p className="text-lg text-gray-400">I enjoy coding the most when I'm building solutions for others. 
      ...
      <section id="projects" className="px-6">
          ...
          <div className="rounded-2xl">
            <h3 className="text-xl mb-2">Clearer</h3>
            <p className="mb-4 text-gray-400">An assistive reading tool for children with Auditory Processing Disorder built in Android.</p>
            <a href="https://github.com/MastracciN/Clearer" className="text-blue-600 hover:underline">View Project →</a>
          </div>
      </section>

      <section id="links" className="py-10 px-6">
        <h2 className="text-4xl mb-10">Links</h2>
